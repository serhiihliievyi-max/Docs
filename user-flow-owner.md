...
> По умолчанию машина **не доступна**. Владелец явно указывает периоды когда машина доступна. Либо ставит флаг "всегда доступна" — тогда записей в `car_slots` нет, машина всегда открыта для брони.
...
- [[entities#car_slots]] — доступность
